...
const TOPICS: Record<string, { name: string; subcategory: string; articles: string[] }> = {
  ...
  // ============================================================================
  // PHASE 7: MYTHOLOGY EXPANSION
  // ============================================================================

  // Greek Mythology
  'greek-mythology': {
    name: 'Greek Mythology',
    subcategory: 'mythology/greek',
    articles: [
      // Olympian Gods
      'Zeus',
      'Hera',
  ...
  // Hindu Mythology (supplement to epics)
  'hindu-mythology': {
    name: 'Hindu Mythology',
    subcategory: 'mythology/hindu',
    articles: [
      // Trimurti
      'Brahma',
      'Vishnu',
  ...
  'arthurian-legend': {
    ...
    subcategory: 'mythology/arthurian',
    articles: [
      'King Arthur',
      'Matter of Britain',
      'Excalibur',
  ...
  'mesopotamian-mythology': {
    ...
    subcategory: 'mythology/mesopotamian',
    articles: [
      'Mesopotamian mythology',
      // Sumerian
      'Sumerian religion',
  ...
  // ============================================================================
  // PHASE 8: INDIA-FOCUSED CONTENT
  // ============================================================================

  // Indian Geography
  'indian-geography': {
    name: 'Indian Geography',
    subcategory: 'geography/indian',
    articles: [
  ...
  // Indian Cricket (expanded)
  'indian-cricket': {
    name: 'Indian Cricket',
    subcategory: 'sports/cricket-india',
    articles: [
      // World Cups
      '1983 Cricket World Cup',
      '2011 Cricket World Cup',
  ...
  'bollywood': {
    name: 'Bollywood',
    subcategory: 'entertainment/bollywood',
    articles: [
      // Industry
      'Bollywood',
      'Hindi cinema',
  ...
  'south-indian-cinema': {
    ...
    subcategory: 'entertainment/south-indian',
    articles: [
      // Industries
      'Telugu cinema',
      'Tamil cinema',
  ...
  'indian-tv': {
    ...
    subcategory: 'entertainment/indian-tv',
    articles: [
      // Classic Shows (DD Era)
  ...
  'indian-culture': {
    name: 'Indian Culture & Festivals',
    subcategory: 'culture/indian',
    articles: [
      // Major Festivals
      'Diwali',
      'Holi',
  ...
  // Indian Science & Achievements
  'indian-science': {
    name: 'Indian Science & Achievements',
    subcategory: 'science/indian',
    articles: [
      // Space Program
      'Indian Space Research Organisation',
      'Vikram Sarabhai',
  ...
  'indian-business': {
    name: 'Indian Business & Economy',
    subcategory: 'business/indian',
    articles: [
      // Conglomerates
      'Tata Group',
      'Reliance Industries',
